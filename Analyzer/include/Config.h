...
#include "Framework/Framework/include/Photon.h"
#include "Framework/Framework/include/PrepNTupleVars.h" #include "Framework/Framework/include/RunTopTagger.h"
...
class Config {
   private:
    void registerModules(NTupleReader& tr,
        ...
        const auto& DeepESMCfg_NonIsoMuon =
            tr.getVar<std::string>("DeepESMCfg_NonIsoMuon");
        const auto& DoubleDisCo_Cfg_0l =
            tr.getVar<std::string>("DoubleDisCo_Cfg_0l");
        const auto& DoubleDisCo_Model_0l =
            tr.getVar<std::string>("DoubleDisCo_Model_0l");
        const auto& DoubleDisCo_Cfg_NonIsoMuon_0l =
            tr.getVar<std::string>("DoubleDisCo_Cfg_NonIsoMuon_0l");
        const auto& DoubleDisCo_Cfg_1l =
            tr.getVar<std::string>("DoubleDisCo_Cfg_1l");
        const auto& DoubleDisCo_Model_1l =
            tr.getVar<std::string>("DoubleDisCo_Model_1l");
        const auto& DoubleDisCo_Cfg_NonIsoMuon_1l =
            tr.getVar<std::string>("DoubleDisCo_Cfg_NonIsoMuon_1l");
        // const auto& DoubleDisCo_Cfg_2l    =
        // tr.getVar<std::string>("DoubleDisCo_Cfg_2l"   ); const auto&
        // DoubleDisCo_Model_2l  = tr.getVar<std::string>("DoubleDisCo_Model_2l"
        // ); const auto& DoubleDisCo_Cfg_NonIsoMuon_2l =
        // tr.getVar<std::string>("DoubleDisCo_Cfg_NonIsoMuon_2l");
        ...
        for (const auto& module : modules) {
            if (module == "PartialUnBlinding")
                tr.emplaceModule<PartialUnBlinding>();
            else if (module == "PrepNTupleVars")
                tr.emplaceModule<PrepNTupleVars>();
            else if (module == "RunTopTagger")
                tr.emplaceModule<RunTopTagger>(TopTaggerCfg);
            else if (module == "Muon")
                tr.emplaceModule<Muon>();
            else if (module == "Electron")
                tr.emplaceModule<Electron>();
            else if (module == "Photon")
                tr.emplaceModule<Photon>();
            else if (module == "Jet")
                tr.emplaceModule<Jet>();
            else if (module == "BJet")
                tr.emplaceModule<BJet>();
            else if (module == "CommonVariables")
                tr.emplaceModule<CommonVariables>();
            else if (module == "MakeMVAVariables")
                tr.emplaceModule<MakeMVAVariables>(false, "", "GoodJets_pt30",
                                                   false, true, 12, 2, "");
            else if (module == "MakeMVAVariables_NonIsoMuon")
                tr.emplaceModule<MakeMVAVariables>(
                    false, "", "NonIsoMuonJets_pt30", false, true, 12, 2, "");
            else if (module == "MakeMVAVariables_0l")
                tr.emplaceModule<MakeMVAVariables>(false, "", "GoodJets_pt45",
                                                   false, true, 12, 2, "_0l");
            else if (module == "MakeMVAVariables_NonIsoMuon_0l")
                tr.emplaceModule<MakeMVAVariables>(false, "",
                                                   "NonIsoMuonJets_pt45", false,
                                                   true, 12, 2, "_0l");
            else if (module == "MakeMVAVariables_1l")
                tr.emplaceModule<MakeMVAVariables>(false, "", "GoodJets_pt30",
                                                   false, true, 12, 2, "_1l");
            else if (module == "MakeMVAVariables_NonIsoMuon_1l")
                tr.emplaceModule<MakeMVAVariables>(false, "",
                                                   "NonIsoMuonJets_pt30", false,
                                                   true, 12, 2, "_1l");
            else if (module == "MakeMVAVariables_2l")
                tr.emplaceModule<MakeMVAVariables>(
                    false, "", "GoodJets_pt30_GoodLeptons_pt20", false, true,
                    12, 2, "_2l");
            else if (module == "Baseline")
                tr.emplaceModule<Baseline>();
            else if (module == "StopGenMatch")
                tr.emplaceModule<StopGenMatch>();
            else if (module == "MegaJetCombine")
                tr.emplaceModule<MegaJetCombine>();
            else if (module == "FatJetCombine")
                tr.emplaceModule<FatJetCombine>();
            else if (module == "TrainingNTupleVars")
                tr.emplaceModule<TrainingNTupleVars>();
            else if (module == "MakeStopHemispheres_All")
                tr.emplaceModule<MakeStopHemispheres>("Jets", "AllJets",
                                                      "NJets", "_All", "",
                                                      Hemisphere::InvMassSeed);
            else if (module == "MakeStopHemispheres_OldSeed")
                tr.emplaceModule<MakeStopHemispheres>(
                    "Jets", "GoodJets_pt20", "NGoodJets_pt20", "_OldSeed", "",
                    Hemisphere::InvMassSeed);
            else if (module == "MakeStopHemispheres_NonIsoMuon_OldSeed")
                tr.emplaceModule<MakeStopHemispheres>(
                    "Jets", "NonIsoMuonJets_pt20", "NNonIsoMuonJets_pt30",
                    "_NonIsoMuon_OldSeed", "", Hemisphere::InvMassSeed);
            else if (module == "MakeStopHemispheres_OldSeed_maskedISR")
                tr.emplaceModule<MakeStopHemispheres>(
                    "Jets", "GoodJets_pt20_maskedISR",
                    "NGoodJets_pt20_maskedISR", "_OldSeed_maskedISR", "",
                    Hemisphere::InvMassSeed);
            else if (module == "MakeStopHemispheres_TopSeed")
                tr.emplaceModule<MakeStopHemispheres>(
                    "StopJets", "GoodStopJets", "NGoodStopJets", "_TopSeed", "",
                    Hemisphere::TopSeed);
            else if (module == "MakeStopHemispheres_TopSeed_maskedISR")
                tr.emplaceModule<MakeStopHemispheres>(
                    "StopJets", "GoodStopJets_maskedISR",
                    "NGoodStopJets_maskedISR", "_TopSeed_maskedISR", "",
                    Hemisphere::TopSeed);
            else if (module == "StopJets")
                tr.emplaceModule<StopJets>();
            else if (module == "ISRJets")
                tr.emplaceModule<ISRJets>();
            else if (module == "DeepEventShape")
                tr.emplaceModule<DeepEventShape>(DeepESMCfg, DeepESMModel);
            else if (module == "DeepEventShape_NonIsoMuon")
                tr.emplaceModule<DeepEventShape>(DeepESMCfg_NonIsoMuon,
                                                 DeepESMModel);
            else if (module == "DoubleDisCo_0l")
                tr.emplaceModule<DeepEventShape>(DoubleDisCo_Cfg_0l,
                                                 DoubleDisCo_Model_0l);
            else if (module == "DoubleDisCo_NonIsoMuon_0l")
                tr.emplaceModule<DeepEventShape>(DoubleDisCo_Cfg_NonIsoMuon_0l,
                                                 DoubleDisCo_Model_0l);
            else if (module == "DoubleDisCo_1l")
                tr.emplaceModule<DeepEventShape>(DoubleDisCo_Cfg_1l,
                                                 DoubleDisCo_Model_1l);
            else if (module == "DoubleDisCo_NonIsoMuon_1l")
                tr.emplaceModule<DeepEventShape>(DoubleDisCo_Cfg_NonIsoMuon_1l,
                                                 DoubleDisCo_Model_1l);
            // else if(module=="DoubleDisCo_2l")
            // tr.emplaceModule<DeepEventShape>(DoubleDisCo_Cfg_2l,
            // DoubleDisCo_Model_2l);

            if (runtype == "MC") {
                if (module == "ScaleFactors")
                    tr.emplaceModule<ScaleFactors>(runYear, leptonFileName,
                                                   puFileName, meanFileName);
                else if (module == "BTagCorrector") {
                    auto& bTagCorrector = tr.emplaceModule<BTagCorrector>(
                        bjetFileName, "", bjetCSVFileName, filetag);
                    bTagCorrector.SetVarNames(
                        "GenParticles_PdgId", "Jets", "GoodJets_pt30",
                        "Jets_bJetTagDeepCSVtotb", "Jets_partonFlavor");
>>>>>>> Init Charlie
                }
            }
        }
   ...
   public:
    ...
    void setUp(NTupleReader& tr) const {
        ...
        const bool isSignal = (filetag.find("_stop") != std::string::npos ||
                               filetag.find("_mStop") != std::string::npos ||
                               filetag.find("VLQ_2t4b") != std::string::npos)
                                  ? true
                                  : false;
...
=======
        ...
        std::string DoubleDisCo_Cfg_0l, DoubleDisCo_Model_0l,
            DoubleDisCo_Cfg_NonIsoMuon_0l;
        std::string DoubleDisCo_Cfg_1l, DoubleDisCo_Model_1l,
            DoubleDisCo_Cfg_NonIsoMuon_1l;
        // std::string DoubleDisCo_Cfg_2l, DoubleDisCo_Model_2l,
        // DoubleDisCo_Cfg_NonIsoMuon_2l;
        std::string puFileName, leptonFileName, bjetFileName, bjetCSVFileName,
            meanFileName, TopTaggerCfg;

        double Lumi = 0.0, deepCSV_WP_loose = 0.0, deepCSV_WP_medium = 0.0,
               deepCSV_WP_tight = 0.0;
        bool blind = true;
        ...
        if (filetag.find("2016") != std::string::npos) {
            ...
            DoubleDisCo_Cfg_NonIsoMuon_0l =
                "Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_0l_2016.cfg";
            ...
            DoubleDisCo_Cfg_NonIsoMuon_1l =
                "Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_1l_2016.cfg";
            // DoubleDisCo_Cfg_2l    =
            // "Keras_Tensorflow_DoubleDisCo_Reg_2l_2016.cfg";
            // DoubleDisCo_Model_2l  =
            // "keras_frozen_DoubleDisCo_Reg_2l_2016.pb";
            // DoubleDisCo_Cfg_NonIsoMuon_2l =
            // "Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_2l_2016.cfg";
            ...
            // DoubleDisCo_Cfg_0l    =
            // "Keras_Tensorflow_DoubleDisCo_Reg_0l_2017.cfg";
            // DoubleDisCo_Model_0l  =
            // "keras_frozen_DoubleDisCo_Reg_0l_2017.pb";
            // DoubleDisCo_Cfg_NonIsoMuon_0l =
            // "Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_0l_2017.cfg";
            // DoubleDisCo_Cfg_1l    =
            // "Keras_Tensorflow_DoubleDisCo_Reg_1l_2017.cfg";
            // DoubleDisCo_Model_1l  =
            // "keras_frozen_DoubleDisCo_Reg_1l_2017.pb";
            // DoubleDisCo_Cfg_NonIsoMuon_1l =
            // "Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_1l_2017.cfg";
            // DoubleDisCo_Cfg_2l    =
            // "Keras_Tensorflow_DoubleDisCo_Reg_2l_2017.cfg";
            // DoubleDisCo_Model_2l  =
            // "keras_frozen_DoubleDisCo_Reg_2l_2017.pb";
            // DoubleDisCo_Cfg_NonIsoMuon_2l =
            // "Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_2l_2017.cfg";
            ...
            // DoubleDisCo_Cfg_0l    =
            // "Keras_Tensorflow_DoubleDisCo_Reg_0l_2018pre.cfg";
            // DoubleDisCo_Model_0l  =
            // "keras_frozen_DoubleDisCo_Reg_0l_2018pre.pb";
            // DoubleDisCo_Cfg_NonIsoMuon_0l =
            // "Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_0l_2018pre.cfg";
            // DoubleDisCo_Cfg_1l    =
            // "Keras_Tensorflow_DoubleDisCo_Reg_1l_2018pre.cfg";
            // DoubleDisCo_Model_1l  =
            // "keras_frozen_DoubleDisCo_Reg_1l_2018pre.pb";
            // DoubleDisCo_Cfg_NonIsoMuon_1l =
            // "Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_1l_2018pre.cfg";
            // DoubleDisCo_Cfg_2l    =
            // "Keras_Tensorflow_DoubleDisCo_Reg_2l_2018pre.cfg";
            // DoubleDisCo_Model_2l  =
            // "keras_frozen_DoubleDisCo_Reg_2l_2018pre.pb";
            // DoubleDisCo_Cfg_NonIsoMuon_2l =
            // "Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_2l_2018pre.cfg";
            ...
            // DoubleDisCo_Cfg_0l    =
            // "Keras_Tensorflow_DoubleDisCo_Reg_0l_2018post.cfg";
            // DoubleDisCo_Model_0l  =
            // "eras_frozen_DoubleDisCo_Reg_0l_2018post.pb";
            // DoubleDisCo_Cfg_NonIsoMuon_0l =
            // "Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_0l_2018post.cfg";
            // DoubleDisCo_Cfg_1l    =
            // "Keras_Tensorflow_DoubleDisCo_Reg_1l_2018post.cfg";
            // DoubleDisCo_Model_1l  =
            // "keras_frozen_DoubleDisCo_Reg_1l_2018pre.pb";
            // DoubleDisCo_Cfg_NonIsoMuon_1l =
            // "Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_1l_2018post.cfg";
            // DoubleDisCo_Cfg_2l    =
            // "Keras_Tensorflow_DoubleDisCo_Reg_2l_2018post.cfg";
            // DoubleDisCo_Model_2l  =
            // "keras_frozen_DoubleDisCo_Reg_2l_2018post.pb";
            // DoubleDisCo_Cfg_NonIsoMuon_2l =
            // "Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_2l_2018post.cfg";
            puFileName = "PileupHistograms_2018_69mb_pm5.root";
            leptonFileName = "allInOne_leptonSF_2018.root";
            bjetFileName = "allInOne_BTagEff.root";
            bjetCSVFileName = "DeepCSV_102XSF_WP_V1.csv";
        ...
        tr.registerDerivedVar("DoubleDisCo_Cfg_NonIsoMuon_0l",
                              DoubleDisCo_Cfg_NonIsoMuon_0l);
        ...
        tr.registerDerivedVar("DoubleDisCo_Cfg_NonIsoMuon_1l",
                              DoubleDisCo_Cfg_NonIsoMuon_1l);
        // tr.registerDerivedVar("DoubleDisCo_Cfg_2l",    DoubleDisCo_Cfg_2l );
        // tr.registerDerivedVar("DoubleDisCo_Model_2l",  DoubleDisCo_Model_2l
        // ); tr.registerDerivedVar("DoubleDisCo_Cfg_NonIsoMuon_2l",
        // DoubleDisCo_Cfg_NonIsoMuon_2l   );
...
<<<<<<< HEAD
        ...
        {
=======
            const std::vector<std::string> modulesList = {"PartialUnBlinding",
                                                          "PrepNTupleVars",
                                                          "Muon",
                                                          "Electron",
                                                          "Photon",
...
=======
                   ...
                   analyzer == "HadTriggers_Analyzer" ||
                   analyzer == "CalculateBTagSF" ||
                   analyzer == "CalculateSFMean") {
            const std::vector<std::string> modulesList = {"PartialUnBlinding",
                                                          "PrepNTupleVars",
                                                          "Muon",
                                                          "Electron",
