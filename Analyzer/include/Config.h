...
private:
    void registerModules(NTupleReader& tr, const std::vector<std::string>&& modules) const
    {
        ...
        for(const auto& module : modules)
        {
            ...
            else if(module=="MakeStopHemispheres_All")      tr.emplaceModule<MakeStopHemispheres>("Jets",     "AllJets",       "NJets",          "_All", "InvMass");
            else if(module=="MakeStopHemispheres_1l")       tr.emplaceModule<MakeStopHemispheres>("Jets",     "GoodJets_pt30", "NGoodJets_pt30", "_1l", "InvMass");
            else if(module=="MakeStopHemispheres_0l")       tr.emplaceModule<MakeStopHemispheres>("Jets",     "GoodJets_pt20", "NGoodJets_pt20", "_0l", "InvMass");
...
//                "MegaJetCombine",
        ...
        else if(analyzer=="StealthHemispheres" || analyzer=="Semra_Analyzer" || analyzer=="Analyze0LepCutFlow")
        {
            const std::vector<std::string> modulesList = {
                "PartialUnBlinding",
                "PrepNTupleVars",
