...
private:
    void registerModules(NTupleReader& tr, const std::vector<std::string>&& modules) const
    {
        ...
        for(const auto& module : modules)
        {
            ...
            else if(module=="MakeStopHemispheres_0l_cm")       tr.emplaceModule<MakeStopHemispheres>("Jets_cm", "GoodJets_pt20", "NGoodJets_pt20", "_0l_cm", Hemisphere::InvMassSeed);
