...
def make1DRatioPlot(dataNum, dataDen, mcNum, mcDen):
    ...
    if dataset == "TTbar":
        ...
        iamLegend.AddEntry(dataRatio, "Data_JetHT", "E1 P")
...
if __name__ == '__main__':
    ...
    varTags      = [ "topPt" ]
    nJetCutTags  = [ "7", "8", "9", "10", "11", "12incl", "7incl" ]
    ...
    dataFile = 0
    if   cr == "TTbar": dataFile = ROOT.TFile.Open(fullPath + "/" + year + "_Data_SingleMuon.root")
    elif cr == "QCD":   dataFile = ROOT.TFile.Open(fullPath + "/" + year + "_Data_JetHT.root")
    ...
    for nJetCutTag in nJetCutTags:
        denomTag2 = "h_topPt_vs_nJets" + "_" + cr + "_den_" + "Njet" + nJetCutTag
        numerTag2 = "h_topPt_vs_nJets" + "_" + cr + "_num_" + "Njet" + nJetCutTag

        goodName = "TrigEff" + "_" + year + "_num_" + varTag + "_" + nJetCutTag
        ...
        for varTag in binTags:

            denomTag1 = "h_topPt" + "_" + cr + "_den_" + "Njet" + nJetCutTag
            numerTag1 = "h_topPt" + "_" + cr + "_num_" + "Njet" + nJetCutTag
