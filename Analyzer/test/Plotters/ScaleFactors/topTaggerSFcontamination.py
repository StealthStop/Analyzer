...
path = "/uscms/home/jhiltb/nobackup/susy/ZeroAndTwoLep/CMSSW_10_2_9/src/Analyzer/Analyzer/test/condor/hadd_2016postVFP_TopTaggerSF_MC"

ttFile  = ROOT.TFile.Open(path+"/2016postVFP_TT.root")
qcdFile  = ROOT.TFile.Open(path+"/2016postVFP_QCD.root")
bgFile  = ROOT.TFile.Open(path+"/2016postVFP_BG.root")

#sgFile1 = ROOT.TFile.Open(path+"/2016postVFP_RPV_2t6j_mStop-350.root")
#sgFile2 = ROOT.TFile.Open(path+"/2016postVFP_RPV_2t6j_mStop-550.root")
#sgFile3 = ROOT.TFile.Open(path+"/2016postVFP_RPV_2t6j_mStop-850.root")
#sgFile4 = ROOT.TFile.Open(path+"/2016postVFP_RPV_2t6j_mStop-1150.root")

sgFile1 = ROOT.TFile.Open(path+"/2016postVFP_TT.root")
sgFile2 = ROOT.TFile.Open(path+"/2016postVFP_TT.root")
sgFile3 = ROOT.TFile.Open(path+"/2016postVFP_TT.root")
sgFile4 = ROOT.TFile.Open(path+"/2016postVFP_TT.root")
