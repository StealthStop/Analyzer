...
histograms = {
    "h_Njets_?"           : {"logY" : True, "Y" : {"title" : "A.U.", "min" : 0.2}, "X" : {"title" : "N_{Jets}",    "rebin" : 1, "min" :  0,  "max" : 20}},
    ...
    "h_HT_?"                  : {"logY" : True,                                "Y" : {"title" : "A.U.", "min" : 0.2}, "X" : {"title" : "H_{T} [GeV]",          "rebin" : 10, "min" :  0,  "max" : 3500}},
...
backgrounds = {
    "RPV_2t6j_mStop-550"        : {"name" : "RPV m_{ #tilde{t}} = 550 GeV (Med)",                 "color" : 46, "lstyle" : 1, "mstyle" : 8, "lsize" : 3, "msize" : 0},
    #"QCD"      : {"name" : "QCD multijet (Med)",    "color" : 30,  "lstyle" : 1, "mstyle" : 8, "lsize" : 3, "msize" : 0},
    #"TTX"      : {"name" : "t#bar{t} + X (Med)",    "color" : 38,  "lstyle" : 1, "mstyle" : 8, "lsize" : 3, "msize" : 0},
    #"BG_OTHER" : {"name" : "Other (Med)",           "color" : 41,  "lstyle" : 1, "mstyle" : 8, "lsize" : 3, "msize" : 0}
}
...
data = {
    "RPV_2t6j_mStop-550_Nom" : {"name" : "RPV m_{ #tilde{t}} = 550 GeV (Nom.)", "color" : 2, "lstyle" : 1, "mstyle" : 8, "lsize" : 3, "msize" : 1.3}
