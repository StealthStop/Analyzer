...
selections = ["0l_blind_ABCD", "1l_blind_ABCD", "2l_blind_ABCD", "_0l_QCDCR_ABCD", "_1l_QCDCR_ABCD"] 

histograms = {

    # jets
    "h_Njets ?"    : {"logY" : False, "Y" : {"title" : "Events", "min" : 0.2}, "X" : {"title" : "N_{Jets}",        "rebin" : 1, "min" : -0.5, "max" : 20.5}},
    ...
    # bjets
    "h_Nbjets ?"    : {"logY" : False, "Y" : {"title" : "Events", "min" : 0.2}, "X" : {"title" : "N B_{Jets}",       "rebin" : 1, "min" : -0.5, "max" : 20.5}},
    ...
    # tops
    "h_Ntops?"     : {"logY" : False, "Y" : {"title" : "Events", "min" : 0.2}, "X" : {"title" : "N_{Tops}",        "rebin" : 1,  "min" : -0.5,  "max" : 6.5 }},
    ...
    # others
    "h_dRbjet?"    : {"logY" : False, "Y" : {"title" : "A.U.", "min" : 0.2}, "X" : {"title" : "#Delta R B_{Jets}", "rebin" : 1,  "min" : 0,    "max" :    6}},
