...
histograms = {
    ...
    # others
    "h_dRbjets_?"  : {"logY" : True,  "Y" : {"title" : "A.U.", "min" : 0.2}, "X" : {"title" : "#Delta R B_{Jets}", "rebin" : 1,  "min" : 0,    "max" :    6}},
    "h_HT_?"       : {"logY" : True,  "Y" : {"title" : "A.U.", "min" : 0.2}, "X" : {"title" : "H_{T} [GeV]",       "rebin" : 20, "min" : 0,    "max" : 3500}},
    "h_Mbl_?"      : {"logY" : False, "Y" : {"title" : "A.U.", "min" : 0.2}, "X" : {"title" : "M_{b,l} [GeV]",     "rebin" : 10, "min" : 0,    "max" : 360 }}, 
    "h_Mll_?"      : {"logY" : False, "Y" : {"title" : "A.U.", "min" : 0.2}, "X" : {"title" : "M_{l,l} [GeV]",     "rebin" : 10, "min" : 0,    "max" : 360 }},
