...
histograms = {
    ...
    #"h_jetsMass_?" : {"logY" : True,  "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "Jet mass [GeV]",  "rebin" : 5, "min" :  0,   "max" :  500}},
    #"h_jetsPt_?"   : {"logY" : True,  "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "Jet p_{T} [GeV]", "rebin" : 5, "min" :  0,   "max" : 2000}},
    #"h_jetsEta_?"  : {"logY" : False, "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "Jet #eta",        "rebin" : 1, "min" : -6,   "max" :    6}},
    #"h_jetsPhi_?"  : {"logY" : False, "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "Jet #phi",        "rebin" : 1, "min" : -4,   "max" :    4}},

    # bjets
    "h_Nbjets_?"    : {"logY" : True,  "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "N_{BJets}",       "rebin" : 1, "min" : -0.5, "max" : 20.5}},
    #"h_bjetsMass_?" : {"logY" : True,  "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "BJet mass [GeV]",  "rebin" : 5, "min" :  0,   "max" :  500}},
    #"h_bjetsPt_?"   : {"logY" : True,  "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "BJet p_{T} [GeV]", "rebin" : 5, "min" :  0,   "max" : 2000}},
    #"h_bjetsEta_?"  : {"logY" : False, "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "BJet #eta",        "rebin" : 1, "min" : -6,   "max" :    6}},
    #"h_bjetsPhi_?"  : {"logY" : False, "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "BJet #phi",        "rebin" : 1, "min" : -4,   "max" :    4}},
    ...
    "h_HT_?"       : {"logY" : True,  "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "H_{T} [GeV]",     "rebin" : 20, "min" : 0, "max" : 3500}},
    "h_Mbl_?"      : {"logY" : True,  "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "M_{b,l} [GeV]",   "rebin" : 10, "min" : 0, "max" : 360 }}, 
    "h_Mll_?"      : {"logY" : True,  "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "M_{l,l} [GeV]",   "rebin" : 10, "min" : 0, "max" : 360 }},
