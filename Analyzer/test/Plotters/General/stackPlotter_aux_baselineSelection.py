...
selections = ["passBaseline0l_Good", "passBaseline1l_Good"] 

histograms = {
    "h_njets_?"      : {"logY" : True,  "Y" : {"title" : "Events", "min" : 2e-3}, "X" : {"title" : "N_{jets}",        "rebin" : 1, "min" : 7, "max" : 20}},
    ...
    "h_nbjets_?"     : {"logY" : True,  "Y" : {"title" : "Events", "min" : 2e-3}, "X" : {"title" : "N_{bjets}",        "rebin" : 1, "min" : 0, "max" : 10}},
    ...
    "h_ntops_?"      : {"logY" : True,  "Y" : {"title" : "Events", "min" : 2e-3}, "X" : {"title" : "N_{tops}",        "rebin" : 1,  "min" :  0,     "max" : 10 }},
    "h_nRtops_?"     : {"logY" : True,  "Y" : {"title" : "Events", "min" : 2e-3}, "X" : {"title" : "N_{Res. tops}",   "rebin" : 1,  "min" :  0,     "max" : 10 }},
    "h_nMtops_?"     : {"logY" : True,  "Y" : {"title" : "Events", "min" : 2e-3}, "X" : {"title" : "N_{Mer. tops}",   "rebin" : 1,  "min" :  0,     "max" : 10 }},
    ...
    "h_6thJetPt_?"   : {"logY" : True,  "Y" : {"title" : "Events", "min" : 0.2 }, "X" : {"title" : "6th Jet p_{T} [GeV]",   "rebin" : 25, "min" : 0,   "max" : 200  }},
    "h_ht_?"         : {"logY" : True,  "Y" : {"title" : "Events", "min" : 2e-3}, "X" : {"title" : "H_{T} [GeV]",           "rebin" : 1,  "min" : 500, "max" : 3000 }},  
    "h_dR_bjets_?"   : {"logY" : True,  "Y" : {"title" : "Events", "min" : 2e-3}, "X" : {"title" : "#DeltaR_{bjets}",       "rebin" : 1,  "min" :  0,   "max" : 10  }}, 
    "h_mbl_?"        : {"logY" : True,  "Y" : {"title" : "Events", "min" : 2e-3}, "X" : {"title" : "M_{b,l} [GeV]",         "rebin" : 10, "min" :  0,   "max" : 500 }},  
}
