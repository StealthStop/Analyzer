...
histograms = {
    ...
    "h_DoubleDisCo_RPV_disc1_?"  : {"logY" : False,  "Y" : {"title" : "Events", "min" : 0.2}, "X" : {"title" : "S_{NN,1}", "rebin" : 5,  "min" : 0, "max" :    1.0}},
    "h_DoubleDisCo_RPV_disc2_?"  : {"logY" : False,  "Y" : {"title" : "Events", "min" : 0.2}, "X" : {"title" : "S_{NN,2}", "rebin" : 5,  "min" : 0, "max" :    1.0}},
    #"h_DoubleDisCo_SYY_disc1_?"  : {"logY" : False,  "Y" : {"title" : "Normalized Event Yield", "min" : 0.2}, "X" : {"title" : "S_{NN,1}", "rebin" : 5,  "min" : 0, "max" :    1.0}},
    #"h_DoubleDisCo_SYY_disc2_?"  : {"logY" : False,  "Y" : {"title" : "Normalized Event Yield", "min" : 0.2}, "X" : {"title" : "S_{NN,2}", "rebin" : 5,  "min" : 0, "max" :    1.0}},

    # jets
    #"h_Njets_?"    : {"logY" : True,  "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "N_{Jets}",        "rebin" : 1, "min" : -0.5, "max" : 19.5}},
    ...
    #"h_njets_10incl_SYY_?"    : {"logY" : True,  "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "N_{Jets}",        "rebin" : 1, "min" : -0.5, "max" : 19.5}},
    #"h_njets_11incl_SYY_?"    : {"logY" : True,  "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "N_{Jets}",        "rebin" : 1, "min" : -0.5, "max" : 19.5}},
    #"h_njets_12incl_SYY_?"    : {"logY" : True,  "Y" : {"title" : "Number of Events", "min" : 0.2}, "X" : {"title" : "N_{Jets}",        "rebin" : 1, "min" : -0.5, "max" : 19.5}},
