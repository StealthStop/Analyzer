...
histograms = {
    "Jet_cm_pt_@?"                  : {"logY" : True,  "orders" : list(xrange(1,7)),  "Y" : {"title" : "Weighted Events", "min" : 0.2},  "X" : {"title" : "Jet @ p_{T} [GeV]",     "rebin" : 2, "min" :  0, "max" : 1500}},
    "Jet_cm_eta_@?"                 : {"logY" : False, "orders" : list(xrange(1,7)),  "Y" : {"title" : "Weighted Events", "min" : 0.2},  "X" : {"title" : "Jet @ #eta",            "rebin" : 1, "min" : -4, "max" :    4}},
    "Jet_cm_phi_@?"                 : {"logY" : False, "orders" : list(xrange(1,7)),  "Y" : {"title" : "Weighted Events", "min" : 0.2},  "X" : {"title" : "Jet @ #phi",            "rebin" : 1, "min" : -6, "max" :    6}},
    "Jet_cm_m_@?"                   : {"logY" : False, "orders" : list(xrange(1,7)),  "Y" : {"title" : "Weighted Events", "min" : 0.2},  "X" : {"title" : "Jet @ mass [GeV]",      "rebin" : 2, "min" :  0, "max" :  150}},
    "Jet_cm_flavb_@?"               : {"logY" : True,  "orders" : list(xrange(1,7)),  "Y" : {"title" : "Weighted Events", "min" : 0.2},  "X" : {"title" : "Jet @ DeepFlavor b",    "rebin" : 1, "min" :  0, "max" :    1}},
    "Jet_cm_flavc_@?"               : {"logY" : True,  "orders" : list(xrange(1,7)),  "Y" : {"title" : "Weighted Events", "min" : 0.2},  "X" : {"title" : "Jet @ DeepFlavor c",    "rebin" : 1, "min" :  0, "max" :    1}},
    "Jet_cm_flavuds_@?"             : {"logY" : True,  "orders" : list(xrange(1,7)),  "Y" : {"title" : "Weighted Events", "min" : 0.2},  "X" : {"title" : "Jet @ DeepFlavor uds",  "rebin" : 1, "min" :  0, "max" :    1}},
    "Jet_cm_flavq_@?"               : {"logY" : True,  "orders" : list(xrange(1,7)),  "Y" : {"title" : "Weighted Events", "min" : 0.2},  "X" : {"title" : "Jet @ DeepFlavor q",    "rebin" : 1, "min" :  0, "max" :    1}},
    "Jet_cm_flavg_@?"               : {"logY" : True,  "orders" : list(xrange(1,7)),  "Y" : {"title" : "Weighted Events", "min" : 0.2},  "X" : {"title" : "Jet @ DeepFlavor g",    "rebin" : 1, "min" :  0, "max" :    1}},
    "h_ht?"                         : {"logY" : True,  "orders" : list(xrange(1,7)),  "Y" : {"title" : "Weighted Events", "min" : 0.2},  "X" : {"title" : "H_{T} [GeV]",           "rebin" : 5, "min" :  0, "max" : 3500}},
