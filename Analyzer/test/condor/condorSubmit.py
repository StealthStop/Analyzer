...
def main():
    ...
    filestoTransfer = [testDir + "/MyAnalysis", 
                       ...
                       testDir + "/Keras_Tensorflow_DoubleDisCo_Reg_0l_RPV_Run2_MaxSig.cfg",
                       testDir + "/Keras_Tensorflow_DoubleDisCo_Reg_1l_RPV_Run2_MaxSig.cfg",
                       testDir + "/Keras_Tensorflow_DoubleDisCo_Reg_2l_RPV_Run2_MaxSig.cfg",
                       testDir + "/Keras_Tensorflow_DoubleDisCo_Reg_0l_SYY_Run2_MaxSig.cfg",
                       testDir + "/Keras_Tensorflow_DoubleDisCo_Reg_1l_SYY_Run2_MaxSig.cfg",
                       testDir + "/Keras_Tensorflow_DoubleDisCo_Reg_2l_SYY_Run2_MaxSig.cfg",
                       testDir + "/Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_0l_RPV_Run2_MaxSig.cfg",
                       testDir + "/Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_1l_RPV_Run2_MaxSig.cfg",
                       testDir + "/Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_2l_RPV_Run2_MaxSig.cfg",
                       testDir + "/Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_0l_SYY_Run2_MaxSig.cfg",
                       testDir + "/Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_1l_SYY_Run2_MaxSig.cfg",
                       testDir + "/Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_2l_SYY_Run2_MaxSig.cfg",
                       testDir + "/keras_frozen_DoubleDisCo_Reg_0l_RPV_Run2_MaxSig.pb",
                       testDir + "/keras_frozen_DoubleDisCo_Reg_1l_RPV_Run2_MaxSig.pb",
                       testDir + "/keras_frozen_DoubleDisCo_Reg_2l_RPV_Run2_MaxSig.pb",
                       testDir + "/keras_frozen_DoubleDisCo_Reg_0l_SYY_Run2_MaxSig.pb",
                       testDir + "/keras_frozen_DoubleDisCo_Reg_1l_SYY_Run2_MaxSig.pb",
                       testDir + "/keras_frozen_DoubleDisCo_Reg_2l_SYY_Run2_MaxSig.pb",
                       testDir + "/Keras_Tensorflow_DoubleDisCo_Reg_0l_RPV_Run2_MassExclusion.cfg",
                       testDir + "/Keras_Tensorflow_DoubleDisCo_Reg_1l_RPV_Run2_MassExclusion.cfg",
                       testDir + "/Keras_Tensorflow_DoubleDisCo_Reg_2l_RPV_Run2_MassExclusion.cfg",
                       testDir + "/Keras_Tensorflow_DoubleDisCo_Reg_0l_SYY_Run2_MassExclusion.cfg",
                       testDir + "/Keras_Tensorflow_DoubleDisCo_Reg_1l_SYY_Run2_MassExclusion.cfg",
                       testDir + "/Keras_Tensorflow_DoubleDisCo_Reg_2l_SYY_Run2_MassExclusion.cfg",
                       testDir + "/Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_0l_RPV_Run2_MassExclusion.cfg",
                       testDir + "/Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_1l_RPV_Run2_MassExclusion.cfg",
                       testDir + "/Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_2l_RPV_Run2_MassExclusion.cfg",
                       testDir + "/Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_0l_SYY_Run2_MassExclusion.cfg",
                       testDir + "/Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_1l_SYY_Run2_MassExclusion.cfg",
                       testDir + "/Keras_Tensorflow_NonIsoMuon_DoubleDisCo_Reg_2l_SYY_Run2_MassExclusion.cfg",
                       testDir + "/keras_frozen_DoubleDisCo_Reg_0l_RPV_Run2_MassExclusion.pb",
                       testDir + "/keras_frozen_DoubleDisCo_Reg_1l_RPV_Run2_MassExclusion.pb",
                       testDir + "/keras_frozen_DoubleDisCo_Reg_2l_RPV_Run2_MassExclusion.pb",
                       testDir + "/keras_frozen_DoubleDisCo_Reg_0l_SYY_Run2_MassExclusion.pb",
                       testDir + "/keras_frozen_DoubleDisCo_Reg_1l_SYY_Run2_MassExclusion.pb",
                       testDir + "/keras_frozen_DoubleDisCo_Reg_2l_SYY_Run2_MassExclusion.pb",
                       ...
                       testDir + "/allInOne_TopTagEffandSF_UL_new.root",
