...
def main():
    ...
    if options.haddOther:
        ...
        other_2016preVFP_skim  = ["2016preVFP_Triboson_skim",  "2016preVFP_Diboson_skim",  "2016preVFP_DYJetsToLL_M-50_skim",  "2016preVFP_WJets_skim"]
        other_2016postVFP_skim = ["2016postVFP_Triboson_skim", "2016postVFP_Diboson_skim", "2016postVFP_DYJetsToLL_M-50_skim", "2016postVFP_WJets_skim"]
        other_2017_skim        = ["2017_Triboson_skim",        "2017_Diboson_skim",        "2017_DYJetsToLL_M-50_skim",        "2017_WJets_skim"]
        other_2018_skim        = ["2018_Triboson_skim",        "2018_Diboson_skim",        "2018_DYJetsToLL_M-50_skim",        "2018_WJets_skim"]
        other_skim = other_2016preVFP_skim + other_2016postVFP_skim + other_2017_skim + other_2018_skim
        ...
        for sampleCollection in scl:
            ...
            if sampleCollection in datasets and sampleCollection in other_skim:
                directory = sampleCollection
                files += " %s/%s_skim.root " % (outDir, directory)

        if options.year:
            command = "hadd %s %s/%s_BG_OTHER.root %s" % (haddArgs, outDir, options.year, files)
            
            if "skim" in files:
                command = "hadd %s %s/%s_BG_OTHER_skim.root %s" % (haddArgs, outDir, options.year, files)
