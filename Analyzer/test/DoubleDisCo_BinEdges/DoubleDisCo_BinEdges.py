...
#   -- totalChi2_Val = [ (A2_predicted - A2_actual) / delta_A2 ]^2
# -------------------------------------------------------------------------
def plot_ClosureNjets(bkg, bkgUnc, bkgPred, bkgPredUnc, Njets, year, model, mass, channel, name = ""):
    ...
    fig.savefig("plots/%s_%s/%s/%s_Njets_Region_A_PredVsActual%s_%s.pdf" %(model, mass, channel, year, name, channel))
...
def main():
    ...
    os.system("rm BinEdges_Val_%s_%s_%s.txt" %(args.model, args.mass, args.channel))
    ...
    for njet in njets: 
        ...
        if finalDisc1Key == -1.0 or finalDisc2Key == -1.0:
            ...
            bkgNjetsPred_A["value"].append(0.0); bkgNjetsPred_A["error"].append(0.0)
        ...
        # --------------------------------
        # calculate closure for Validation
        # --------------------------------
        if finalDisc1Key_Val == -1.0 or finalDisc2Key_Val == -1.0:

            sigNjets["A2"].append(0.0); sigNjetsErr["A2"].append(0.0)
            sigNjets["B2"].append(0.0); sigNjetsErr["B2"].append(0.0)
            sigNjets["C2"].append(0.0); sigNjetsErr["C2"].append(0.0)
            sigNjets["D2"].append(0.0); sigNjetsErr["D2"].append(0.0)

            bkgNjets["A2"].append(0.0); bkgNjetsErr["A2"].append(0.0)
            bkgNjets["B2"].append(0.0); bkgNjetsErr["B2"].append(0.0)
            bkgNjets["C2"].append(0.0); bkgNjetsErr["C2"].append(0.0)
            bkgNjets["D2"].append(0.0); bkgNjetsErr["D2"].append(0.0)

            bkgNjetsPred_A["value_val"].append(0.0); bkgNjetsPred_A["error_val"].append(0.0)

        else:

            closure_Val, closureUnc_Val, pred_A2, predUnc_A2 = cal_simpleClosureABCD2( nTotBkgCount_ABCD2["nBkgEvents_A2"][finalDisc1Key_Val][finalDisc2Key_Val],    nTotBkgCount_ABCD2["nBkgEvents_B2"][finalDisc1Key_Val][finalDisc2Key_Val],
                                                                                       nTotBkgCount_ABCD2["nBkgEvents_C2"][finalDisc1Key_Val][finalDisc2Key_Val],    nTotBkgCount_ABCD2["nBkgEvents_D2"][finalDisc1Key_Val][finalDisc2Key_Val],
                                                                                       nTotBkgCount_ABCD2["nBkgEventsErr_A2"][finalDisc1Key_Val][finalDisc2Key_Val], nTotBkgCount_ABCD2["nBkgEventsErr_B2"][finalDisc1Key_Val][finalDisc2Key_Val],
                                                                                       nTotBkgCount_ABCD2["nBkgEventsErr_C2"][finalDisc1Key_Val][finalDisc2Key_Val], nTotBkgCount_ABCD2["nBkgEventsErr_D2"][finalDisc1Key_Val][finalDisc2Key_Val] )

            # --------------------------------
            # make the validation closure plot
            # --------------------------------
            sigNjets["A2"].append(nTotSigCount_ABCD2["nSigEvents_A2"][finalDisc1Key_Val][finalDisc2Key_Val]); sigNjetsErr["A2"].append(nTotSigCount_ABCD2["nSigEventsErr_A2"][finalDisc1Key_Val][finalDisc2Key_Val])
            sigNjets["B2"].append(nTotSigCount_ABCD2["nSigEvents_B2"][finalDisc1Key_Val][finalDisc2Key_Val]); sigNjetsErr["B2"].append(nTotSigCount_ABCD2["nSigEventsErr_B2"][finalDisc1Key_Val][finalDisc2Key_Val])
            sigNjets["C2"].append(nTotSigCount_ABCD2["nSigEvents_C2"][finalDisc1Key_Val][finalDisc2Key_Val]); sigNjetsErr["C2"].append(nTotSigCount_ABCD2["nSigEventsErr_C2"][finalDisc1Key_Val][finalDisc2Key_Val])
            sigNjets["D2"].append(nTotSigCount_ABCD2["nSigEvents_D2"][finalDisc1Key_Val][finalDisc2Key_Val]); sigNjetsErr["D2"].append(nTotSigCount_ABCD2["nSigEventsErr_D2"][finalDisc1Key_Val][finalDisc2Key_Val])

            bkgNjets["A2"].append(nTotBkgCount_ABCD2["nBkgEvents_A2"][finalDisc1Key_Val][finalDisc2Key_Val]); bkgNjetsErr["A2"].append(nTotBkgCount_ABCD2["nBkgEventsErr_A2"][finalDisc1Key_Val][finalDisc2Key_Val])
            bkgNjets["B2"].append(nTotBkgCount_ABCD2["nBkgEvents_B2"][finalDisc1Key_Val][finalDisc2Key_Val]); bkgNjetsErr["B2"].append(nTotBkgCount_ABCD2["nBkgEventsErr_B2"][finalDisc1Key_Val][finalDisc2Key_Val])
    ...
    totalChi2, ndof = plot_ClosureNjets(bkgNjets["A2"], bkgNjetsErr["A2"], bkgNjetsPred_A["value_val"], bkgNjetsPred_A["error_val"], Njets, args.year, args.model, args.mass, args.channel, name = "_Val")
