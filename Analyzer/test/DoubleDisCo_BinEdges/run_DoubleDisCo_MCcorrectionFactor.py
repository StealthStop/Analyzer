...
def main():
    ...
    for njet in njets:
        ...
        plotter["TT"].plot_VarVsBoundary(nonClosurePerBoundaryTT,    regionGridWidth/2.0, 0.0, 0.3,  None, "Non-Closure",             "MCNonClosureExt",   njet, color)
        plotter["TT"].plot_VarVsBoundary(closureCorrPerBoundaryTT,   regionGridWidth/2.0, 0.7, 1.3,  None, "Closure Correction [MC]", "MCcorrectionExt", njet, color)
        ...
        if njet == "7":
            ...
            plotter["Data"].plot_VarVsBoundary(closureCorrPerBoundaryTTinData,     regionGridWidth/2.0, 0.7, 1.3, 1.0,  "Closure Correction [Data]",    "DatacorrectionExt",        njet, color)
            plotter["Data"].plot_VarVsBoundary(closureCorrPerBoundaryTTinDataVsTT, regionGridWidth/2.0, 0.7, 1.3, 1.0,  "Closure Correction [Data/MC]", "DataMccorrectionRatioExt", njet, color)
