...
# ---------------------------------------------------
def get_Optimized_ABCDedges(all_ABCDEdges, significance, nonClosure, nonClosure_Pull, sigFracB, sigFracC, sigFracD, sigFracB_Unc, sigFracC_Unc, sigFracD_Unc):
...
def main():
    ...
    # ---------------------------------------------------------
    all_ABCDEdges = {}; significance = {}; nonClosure = {}; nonClosure_Pull = {}
    sigFracB      = {}; sigFracB_Unc = {}; sigFracC   = {}; sigFracC_Unc    = {}; sigFracD = {}; sigFracD_Unc = {}

    for key, region in regions.items():
        all_ABCDEdges[key] = {}; significance[key] = {}; nonClosure[key] = {}; nonClosure_Pull[key] = {}
