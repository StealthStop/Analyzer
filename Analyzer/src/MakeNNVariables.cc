...
void MakeNNVariables::Loop(NTupleReader& tr, double, int maxevents, bool)
{
    ...
    while( tr.getNextEvent() )
    {
        ...
        std::set<std::string> varJets = 
        {
            ...
            "Jet_flavc_1",        "Jet_flavc_2",        "Jet_flavc_3",        "Jet_flavc_4",         "Jet_flavc_5",         "Jet_flavc_6", 
            "Jet_flavc_7",        "Jet_flavc_8",        "Jet_flavc_9",        "Jet_flavc_10",        "Jet_flavc_11",        "Jet_flavc_12",
            "Jet_flavuds_1",      "Jet_flavuds_2",      "Jet_flavuds_3",      "Jet_flavuds_4",       "Jet_flavuds_5",       "Jet_flavuds_6", 
            "Jet_flavuds_7",      "Jet_flavuds_8",      "Jet_flavuds_9",      "Jet_flavuds_10",      "Jet_flavuds_11",      "Jet_flavuds_12",
