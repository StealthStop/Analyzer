...
void HEM_Analyzer::Loop(NTupleReader& tr, double, int maxevents, bool)
{
    while( tr.getNextEvent() )
    {
        ...
        const auto& passBaseline0l_Good_noHEMveto = tr.getVar<bool>("passBaseline0l_Good_noHEMveto"                        );
        const auto& passBaseline1l_Good_noHEMveto = tr.getVar<bool>("passBaseline1l_Good_noHEMveto"                        );
        const auto& passBaseline2l_Good_noHEMveto = tr.getVar<bool>("passBaseline2l_Good_noHEMveto"                        );
        ...
        const std::map<std::string, bool>& cutmap
        {
            ...
            {"passBaseline2l_Good",           passBaseline2l_Good          },  
            {"passBaseline0l_Good_noHEMveto", passBaseline0l_Good_noHEMveto},
            {"passBaseline1l_Good_noHEMveto", passBaseline1l_Good_noHEMveto},
            {"passBaseline2l_Good_noHEMveto", passBaseline2l_Good_noHEMveto},
        };
