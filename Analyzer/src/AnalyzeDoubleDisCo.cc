...
void AnalyzeDoubleDisCo::Loop(NTupleReader& tr, double, int maxevents, bool)
{
    ...
    for(const auto& myVarSuffix : my_var_suffix)
    {
        ...
        MakeStopHemispheres stopHemispheres_TopSeed_NonIsoMuon("Jets",     "NonIsoMuonJets_pt20",     "NNonIsoMuonJets_pt30",     "_TopSeed_NonIsoMuon", myVarSuffix, Hemisphere::InvMassSeed);
