...
getDeepESMCfg.sh -t DoubleDisCo_Reg_1l_Run2_SYY_v3.4.1_patch -o -m DoubleDisCo_Reg.cfg -M DoubleDisCo_Reg_NonIsoMuon.cfg -f Keras_Tensorflow -F Keras_Tensorflow_NonIsoMuon -s DoubleDisCo_Reg_1l_SYY_Run2_MassExclusion
